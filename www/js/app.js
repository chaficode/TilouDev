...
angular
		.module(
				...
				[ 'ionic', 'app.controllers', 'app.routes', 'app.directives',
						'app.services', 'pascalprecht.translate', ])
		...
		/*
		 * This directive is used to disable the "drag to open" functionality of
		 * the Side-Menu when you are dragging a Slider component.
		 */
		.directive(
				'disableSideMenuDrag',
				[
		...
		/*
		 * This directive is used to open regular and dynamic href links inside
		 * of inappbrowser.
		 */
